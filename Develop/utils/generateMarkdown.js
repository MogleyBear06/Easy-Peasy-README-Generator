...
function renderLicenseLink(license) {
  ...
  [${data.email}](mailto:${data.email}). If you're interested in other projects I've created,
  please visit my GitHub page at [https://github.com/${data.username}](https://github.com/${data.username}).
`;
  }
